...
struct MaterialDesignIconView: View {
    let size: CGFloat
    private let fontName: String
    private let text: String

    init(_ icon: MaterialDesignIcon, size: CGFloat = 20) {
        self.text = icon.text
...
public enum MaterialDesignIcon: String, CaseIterable {
    fileprivate var fontName: String { "MaterialIcons-Regular" }
